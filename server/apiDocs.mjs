...
export const endpoints = [
  ...
  { method: 'POST', path: '/api/chat', summary: 'One Head AI turn. Requires a configured provider key; without one it answers 409, never invented text', tags: ['chat'], errors: [400, 404, 409, 502] },
  ...
  { method: 'GET', path: '/api/projects/{projectId}/learnings', summary: 'Durable facts past runs taught this project', tags: ['projects'], errors: [404] },
  { method: 'DELETE', path: '/api/projects/{projectId}/learnings/{learningId}', summary: 'Forget one learning', tags: ['projects'], errors: [404] },
  { method: 'POST', path: '/api/projects/{projectId}/playbooks', summary: 'Save an approved plan as a reusable playbook', tags: ['projects'], errors: [400, 404, 409] },
  { method: 'GET', path: '/api/projects/{projectId}/playbooks', summary: 'Playbooks saved in this project', tags: ['projects'], errors: [404] },
  { method: 'DELETE', path: '/api/projects/{projectId}/playbooks/{playbookId}', summary: 'Delete a playbook', tags: ['projects'], errors: [404] },
  { method: 'POST', path: '/api/projects/{projectId}/playbooks/{playbookId}/runs', summary: 'Run a playbook: the run inherits its approval and starts', tags: ['projects'], errors: [400, 402, 404, 409] },
  { method: 'GET', path: '/api/projects/{projectId}/schedules', summary: 'Playbook schedules and their next fire time', tags: ['projects'], errors: [404] },
  { method: 'POST', path: '/api/projects/{projectId}/schedules', summary: 'Schedule a playbook on an interval like "every 6h"', tags: ['projects'], errors: [400, 404] },
  { method: 'PATCH', path: '/api/projects/{projectId}/schedules/{scheduleId}', summary: 'Toggle or re-budget a schedule', tags: ['projects'], errors: [400, 404] },
  { method: 'DELETE', path: '/api/projects/{projectId}/schedules/{scheduleId}', summary: 'Delete a schedule', tags: ['projects'], errors: [404] },
  { method: 'GET', path: '/api/projects/{projectId}/goals', summary: 'Long-lived objectives with shared budgets', tags: ['projects'], errors: [404] },
  { method: 'POST', path: '/api/projects/{projectId}/goals', summary: 'Start a goal: name, objective, acceptance, optional budget', tags: ['projects'], errors: [400, 404] },
  { method: 'DELETE', path: '/api/projects/{projectId}/goals/{goalId}', summary: 'Delete a goal', tags: ['projects'], errors: [404] },
  { method: 'POST', path: '/api/projects/{projectId}/goals/{goalId}/runs', summary: 'Start a run under a goal, refused past its budget', tags: ['projects'], errors: [400, 402, 404] },
  { method: 'GET', path: '/api/projects/{projectId}/goals/{goalId}/report', summary: 'A goal with its member runs, spend, and chain states', tags: ['projects'], errors: [404] },
  { method: 'GET', path: '/api/blueprints', summary: 'Team setups: builtin blueprints plus the team folder', tags: ['system'] },
  { method: 'POST', path: '/api/projects/{projectId}/blueprints/preview', summary: 'Show exactly what a blueprint would change, writing nothing', tags: ['projects'], errors: [400, 404] },
  { method: 'POST', path: '/api/projects/{projectId}/blueprints/apply', summary: 'Apply a blueprint: routing, defaults, and standing grants', tags: ['projects'], errors: [400, 404] },
  { method: 'GET', path: '/api/marketplace', summary: 'Signed index plus community imports, trust-tagged, staged bytes withheld', tags: ['system'] },
  { method: 'POST', path: '/api/marketplace/refresh', summary: 'Re-fetch and verify the marketplace index', tags: ['system'], errors: [502] },
  { method: 'POST', path: '/api/marketplace/browse', summary: 'Read a public registry listing without staging anything', tags: ['system'], errors: [400, 502] },
  { method: 'POST', path: '/api/marketplace/import', summary: 'Validate, scan, and stage one skill for review — not installed', tags: ['system'], errors: [400, 422] },
  { method: 'GET', path: '/api/arsenal', summary: 'Installed skills and plugins, with update state', tags: ['system'] },
  { method: 'POST', path: '/api/marketplace/{entryId}', summary: 'Install a marketplace entry: hash-pinned, re-validated', tags: ['system'], errors: [400, 404] },
  { method: 'DELETE', path: '/api/marketplace/{entryId}', summary: 'Uninstall and revoke its scoped grants. Idempotent: unknown ids succeed with nothing removed, after the id itself is validated', tags: ['system'], errors: [] },
  { method: 'GET', path: '/api/runs/{runId}/timeline/{sequence}', summary: 'Files this run wrote, as of an event index — with honest gaps', tags: ['runs'], errors: [400, 404] },
  { method: 'POST', path: '/api/runs/{runId}/timeline/{sequence}/restore', summary: 'Restore a file to its snapshot at an event index, through approval', tags: ['runs'], errors: [400, 404, 409] },

  { method: 'POST', path: '/api/runs', summary: 'Create a run in a project, optionally under a goal whose budget gates admission', tags: ['runs'], errors: [400, 402, 404] },
  ...
  { method: 'GET', path: '/api/runs/{runId}/claims', summary: 'The run\u2019s claims: what workers asserted, with evidence links and verdicts', tags: ['runs'], errors: [404] },
